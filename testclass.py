...
class System:
    ...
    def payment(self , customer_id ,payment, order_id):
        order_list = self.search_order_by_account_id(customer_id)
...
class Payment:
    def __init__(self, payment_type, customer_id, payment_detail, amount):
        self.__payment_id = 1
